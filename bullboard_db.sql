-- phpMyAdmin SQL Dump
-- UniFeed - Student Organization Bulletin Board System
...
INSERT INTO `posts` (`post_id`, `user_id`, `org_id`, `category_id`, `title`, `content`, `post_type`, `image_url`, `event_date`, `is_pinned`, `is_active`, `upvotes`, `downvotes`, `comment_count`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 'Welcome to UniFeed!', 'This is the official bulletin board system for CvSU Silang Campus. Share announcements, events, and connect with fellow students!', 'announcement', NULL, NULL, 1, 1, 15, 2, 5, current_timestamp(), current_timestamp()),
(2, 2, 2, 2, 'Upcoming Intramurals 2024', 'Join us for the annual intramurals! Registration starts next week. Various sports categories available.', 'event', NULL, '2024-12-20 09:00:00', 0, 1, 8, 1, 3, current_timestamp(), current_timestamp()),
(3, 1, 1, 3, 'Programming Workshop', 'Free programming workshop for beginners. Learn the basics of web development with HTML, CSS, and JavaScript.', 'event', NULL, '2024-12-18 14:00:00', 0, 1, 23, 0, 12, current_timestamp(), current_timestamp());
